...
import obstacle2 from "../../../assets/img/gif/missile.png";
import obstacle3 from "../../../assets/img/gif/spinyshell.gif";
  ...
  return (
    <div className="obstacles-container">
      ...
      <img
        ...
        style={isPlay ? { animationDuration: `${4.5 - speed}s` } : { animationDuration: `3s` }}
        ref={obstacle3Ref}
      />
    </div>
  );
